...
#define PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                   3
#define PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION                   0
#define PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION                   2
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
/**
 * @internal
 * @brief         Set group1 for an interrupt request.
 */    
extern void IntCtrl_Ip_Group1Privileged(IRQn_Type eIrqNumber);
/**
 * @internal
 * @brief         Set Configure Spi for an interrupt request.
 */ 
extern void IntCtrl_Ip_ConfigureSpiPrivileged(IRQn_Type eIrqNumber, IntCtrl_Ip_TriggerType conf);
/**
 * @internal
 * @brief         Set interrupt target request.
 */ 
extern void IntCtrl_Ip_SetIntTargetPrivileged(IRQn_Type eIrqNumber, IntCtrl_Ip_Routing_ModeType target);
#endif
