...
typedef struct {
  ...
  union {                                          /* offset: 0x2C, array step: 0x2 */
    ...
    __IO uint16_t C[CTU_CLR_COUNT];                  /**< Command List Register C for self-test commands, array offset: 0x2C, array step: 0x2 */
  } CLR;
...
#define CTU_A_ST0_MASK                           (0x200U)
#define CTU_A_ST0_SHIFT                          (9U)
#define CTU_A_ST0_WIDTH                          (1U)
#define CTU_A_ST0(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_A_ST0_SHIFT)) & CTU_A_ST0_MASK)
...
#define CTU_B_ST0_MASK                           (0x200U)
#define CTU_B_ST0_SHIFT                          (9U)
#define CTU_B_ST0_WIDTH                          (1U)
#define CTU_B_ST0(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_B_ST0_SHIFT)) & CTU_B_ST0_MASK)
...
/*! @name C - Command List Register C for self-test commands */
/*! @{ */

#define CTU_C_BSIZE_MASK                         (0x7FU)
#define CTU_C_BSIZE_SHIFT                        (0U)
#define CTU_C_BSIZE_WIDTH                        (7U)
#define CTU_C_BSIZE(x)                           (((uint16_t)(((uint16_t)(x)) << CTU_C_BSIZE_SHIFT)) & CTU_C_BSIZE_MASK)

#define CTU_C_ALG_MASK                           (0x180U)
#define CTU_C_ALG_SHIFT                          (7U)
#define CTU_C_ALG_WIDTH                          (2U)
#define CTU_C_ALG(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_C_ALG_SHIFT)) & CTU_C_ALG_MASK)

#define CTU_C_ST0_MASK                           (0x200U)
#define CTU_C_ST0_SHIFT                          (9U)
#define CTU_C_ST0_WIDTH                          (1U)
#define CTU_C_ST0(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_C_ST0_SHIFT)) & CTU_C_ST0_MASK)

#define CTU_C_ST_SU_MASK                         (0x800U)
#define CTU_C_ST_SU_SHIFT                        (11U)
#define CTU_C_ST_SU_WIDTH                        (1U)
#define CTU_C_ST_SU(x)                           (((uint16_t)(((uint16_t)(x)) << CTU_C_ST_SU_SHIFT)) & CTU_C_ST_SU_MASK)

#define CTU_C_ST_CMS_MASK                        (0x1000U)
#define CTU_C_ST_CMS_SHIFT                       (12U)
#define CTU_C_ST_CMS_WIDTH                       (1U)
#define CTU_C_ST_CMS(x)                          (((uint16_t)(((uint16_t)(x)) << CTU_C_ST_CMS_SHIFT)) & CTU_C_ST_CMS_MASK)

#define CTU_C_ST1_MASK                           (0x2000U)
#define CTU_C_ST1_SHIFT                          (13U)
#define CTU_C_ST1_WIDTH                          (1U)
#define CTU_C_ST1(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_C_ST1_SHIFT)) & CTU_C_ST1_MASK)

#define CTU_C_LC_MASK                            (0x4000U)
#define CTU_C_LC_SHIFT                           (14U)
#define CTU_C_LC_WIDTH                           (1U)
#define CTU_C_LC(x)                              (((uint16_t)(((uint16_t)(x)) << CTU_C_LC_SHIFT)) & CTU_C_LC_MASK)

#define CTU_C_CIR_MASK                           (0x8000U)
#define CTU_C_CIR_SHIFT                          (15U)
#define CTU_C_CIR_WIDTH                          (1U)
#define CTU_C_CIR(x)                             (((uint16_t)(((uint16_t)(x)) << CTU_C_CIR_SHIFT)) & CTU_C_CIR_MASK)
/*! @} */
