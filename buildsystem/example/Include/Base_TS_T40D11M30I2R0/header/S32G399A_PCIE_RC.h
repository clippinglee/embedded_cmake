...
typedef struct {
  ...
  __I  uint32_t RASDP_CORR_ERROR_LOCATION_OFF;     /**< Corrected Errors Location Register., offset: 0x278 */
...
/*! @name RASDP_CORR_ERROR_LOCATION_OFF - Corrected Errors Location Register. */
/*! @{ */
