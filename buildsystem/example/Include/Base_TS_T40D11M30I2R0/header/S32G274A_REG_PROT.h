...
**     Reference manual:    S32G274A RM Rev.1
**     Version:             rev. 1.2
**     Build:               b191209
**
**     Abstract:
...
/*!
 * @file S32G274A_REG_PROT.h
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32G274A_REG_PROT
 *
...
#if !defined(S32G274A_REG_PROT_H_)  /* Check if memory map has not been already included */
#define S32G274A_REG_PROT_H_
...
#endif  /* #if !defined(S32G274A_REG_PROT_H_) */
