...
#define CAIU1_QosGenerator_REVISIONID_FLEXNOCID_MASK (0xFFFFFF00U)
#define CAIU1_QosGenerator_REVISIONID_FLEXNOCID_SHIFT (8U)
#define CAIU1_QosGenerator_REVISIONID_FLEXNOCID_WIDTH (24U)
#define CAIU1_QosGenerator_REVISIONID_FLEXNOCID(x) (((uint32_t)(((uint32_t)(x)) << CAIU1_QosGenerator_REVISIONID_FLEXNOCID_SHIFT)) & CAIU1_QosGenerator_REVISIONID_FLEXNOCID_MASK)
/*! @} */
...
#define CAIU1_QosGenerator_PRIORITY_P1_MASK      (0x300U)
#define CAIU1_QosGenerator_PRIORITY_P1_SHIFT     (8U)
#define CAIU1_QosGenerator_PRIORITY_P1_WIDTH     (2U)
#define CAIU1_QosGenerator_PRIORITY_P1(x)        (((uint32_t)(((uint32_t)(x)) << CAIU1_QosGenerator_PRIORITY_P1_SHIFT)) & CAIU1_QosGenerator_PRIORITY_P1_MASK)
...
#define CAIU1_QosGenerator_MODE_MODE_MASK        (0x3U)
#define CAIU1_QosGenerator_MODE_MODE_SHIFT       (0U)
#define CAIU1_QosGenerator_MODE_MODE_WIDTH       (2U)
#define CAIU1_QosGenerator_MODE_MODE(x)          (((uint32_t)(((uint32_t)(x)) << CAIU1_QosGenerator_MODE_MODE_SHIFT)) & CAIU1_QosGenerator_MODE_MODE_MASK)
/*! @} */
