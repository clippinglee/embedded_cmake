 ...
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32G399A_MPU
 *
...
#if !defined(S32G399A_MPU_H_)  /* Check if memory map has not been already included */
#define S32G399A_MPU_H_
...
#endif  /* #if !defined(S32G399A_MPU_H_) */
