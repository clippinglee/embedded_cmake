...
#define NUMBER_OF_INT_VECTORS 288                /**< Number of interrupts in the Vector table */
...
typedef enum {
  ...
  HardFault_IRQn               = -13,              /**< Cortex-A53 SV Hard Fault Interrupt */
  MemoryManagement_IRQn        = -12,              /**< Cortex-A53 Memory Management Interrupt */
  BusFault_IRQn                = -11,              /**< Cortex-A53 Bus Fault Interrupt */
  UsageFault_IRQn              = -10,              /**< Cortex-A53 Usage Fault Interrupt */
  SVCall_IRQn                  = -5,               /**< Cortex-A53 SV Call Interrupt */
  DebugMonitor_IRQn            = -4,               /**< Cortex-A53 Debug Monitor Interrupt */
  PendSV_IRQn                  = -2,               /**< Cortex-A53 Pend SV Interrupt */
  SysTick_IRQn                 = -1,               /**< Cortex-A53 System Tick Interrupt */
  ...
  COMM_IRQn                    = 22,               /**< Per-core interrupt: Communications channel receive or transmit interrupt request  */
  PMU_IRQn                     = 23,               /**< Per-core interrupt: PMU interrupt request */
  CTI_IRQn                     = 24,               /**< Per-core interrupt: Cross trigger interface (CTI) interrupt */
  MAINTENANCE_IRQn             = 25,               /**< Per-core interrupt: Virtual CPU Interface Maintenance interrupt */
  HYPERV_TIM_IRQn              = 26,               /**< Per-core interrupt: Hypervisor timer interrupt */
  VIRTUAL_TIM_IRQn             = 27,               /**< Per-core interrupt: Virtual timer interrupt */
  EL2_VIRTUAL_TIM_IRQn         = 28,               /**< Per-core interrupt:EL2 Virtual timer interrupt */
  EL3_TIM_IRQn                 = 29,               /**< Per-core interrupt:Secure EL3 physical timer */
  EL1_TIM_IRQn                 = 30,               /**< Per-core interrupt: Non-secure EL1 physical timer */
