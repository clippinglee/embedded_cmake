...
/*!
 * @file S32G274A_SYSTICK.h
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32G274A_SYSTICK
 *
...
#if !defined(S32G274A_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32G274A_SYSTICK_H_
...
#endif  /* #if !defined(S32G274A_SYSTICK_H_) */
