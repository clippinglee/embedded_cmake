...
#define SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS_MASK (0x800000U)
#define SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS_SHIFT (23U)
#define SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS_WIDTH (1U)
#define SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS(x) (((uint32_t)(((uint32_t)(x)) << SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS_SHIFT)) & SerDes_EP_PCIe_1_PORT_FORCE_OFF_DO_DESKEW_FOR_SRIS_MASK)
/*! @} */
