 ...
 * @version 1.0
 * @date 2019-04-17
 * @brief Peripheral Access Layer for S32G274A_SCB
 *
...
#if !defined(S32G274A_SCB_H_)  /* Check if memory map has not been already included */
#define S32G274A_SCB_H_
...
#endif  /* #if !defined(S32G274A_SCB_H_) */
